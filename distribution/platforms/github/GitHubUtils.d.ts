...
) => (path: string, repoSlug?: string | undefined, ref?: string | undefined) => Promise<string>
/** Generates the createUpdatedIssueWithID function, needed so that Peril can re-create this func for an event */
export declare const createUpdatedIssueWithIDGenerator: (
  api: GitHub
) => (
  id: string,
  content: string,
...
export declare const createOrUpdatePR: (
  pr: GitHubPRDSL | undefined,
  api: GitHub
) => (config: PRCreationConfig, fileMap: any) => Promise<GitHub.Response<GitHub.PullsCreateResponse>>
export declare const createOrAddLabel: (
  pr: GitHubPRDSL | undefined,
  api: GitHub
) => (
  labelConfig: {
